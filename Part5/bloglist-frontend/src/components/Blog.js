  ...
  return (
    <div>
      ...
      <tbody style={showDetails}>
        <tr>
          <td>{blog.title}{', by '} {blog.author}</td><td><button className={ 'blogButton' } onClick={toggleVisibility}>{'view'}</button></td>
        </tr>
      </tbody>
      <tbody style={hideDetails} className={"detailsVisible"}>
        <tr>
          <td >{blog.title}</td><td><button className={ 'blogButton' } onClick={toggleVisibility}>{'hide'}</button></td>
        </tr>
        <tr>
          <td >{blog.url}</td>
        </tr>
        <tr>
          <td >{'likes: '}{blog.likes}</td><td> <button className={ 'blogButton' } onClick={handleLike}>{'like'}</button></td>
        </tr>
        <tr>
          <td >{blog.author}</td>
